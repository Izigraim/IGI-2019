...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JobTrackingSystem.Models.TakingTasks", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("JobTrackingSystem.Models.TrackingTask", b =>
                {
                    ...
                    b.Property<int?>("TakingTaskId");

                    b.Property<int?>("TakingTasksId");
            ...
            modelBuilder.Entity("JobTrackingSystem.Models.TrackingTask", b =>
                {
                    b.HasOne("JobTrackingSystem.Models.TakingTasks", "TakingTasks")
                        .WithMany("trackingTasks")
                        .HasForeignKey("TakingTasksId");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("JobTrackingSystem.Models.User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
