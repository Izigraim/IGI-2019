        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    whoGaveId = table.Column<string>(nullable: true),
                    whoTakeId = table.Column<string>(nullable: true),
                    ...
                    TakingTaskId = table.Column<int>(nullable: true),
                    TakingTasksId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TrackingTasks_AspNetUsers_whoTakeId",
